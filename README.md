...
When developing a web application, our primary goal is to take
...
`http://localhost:8080/games`, and hit enter.
...
We can make a POST request using the JavaScript `fetch` API:
